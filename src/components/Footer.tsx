  ...
  return (
    <div className="max-w-sm">
       <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth={1} stroke="white" className="size-5">
        ...
        <p className="mt-4">
            <a className="text-neutral-700 transition hover:text-secondary" href='mailto:hello@ribboncreative.co.uk'>hello@ribboncreative.co.uk</a>
        </p> 
